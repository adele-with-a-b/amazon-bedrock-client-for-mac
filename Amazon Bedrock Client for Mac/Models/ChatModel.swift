...
class ChatModel: ObservableObject, Identifiable, Equatable, Hashable, @unchecked Sendable {
    ...
    var agentId: String? = nil // Agent associated with this chat
    ...
    init(id: String, chatId: String, name: String, title: String, description: String, provider: String, lastMessageDate: Date, isManuallyRenamed: Bool = false, agentId: String? = nil) {
        self.id = id
        self.chatId = chatId
        self.name = name
        self.title = title
